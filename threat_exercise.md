...
Adversaries -
Jennifer, pickpocket, general attackers

Attack surface -
phone, passwords

Attack vectors -
phishing, cookies, spyware

Risks (Confidentiality, Integrity, Availability, etc) -
confidentiality, integrity

Types of Attacks (Man-in-the-middle, (Distributed) denial of service, Backdoors/malware, social, etc.) -
social engineering, cookie forgery, physical theft, spyware, password guessing, 

Mitigation -
log out, add pin, more secure passwords, password manager, 
