...
server.get('/setkey:keyString', (req, res) => {
  ...
  try {
    // TODO:
    // Set secretKey to be whatever the user passes through input
    ...
    res.send(`<div>Key set to new value: ${secretKey}</div>`);
  } catch (err) {
    // failed
