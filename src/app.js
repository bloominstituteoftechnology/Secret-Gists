...
//   const friendSecretKey = nacl.randomBytes(32); ////  generate random utf8array
//   //console.log('friendSecretKey', friendSecretKey);
//   const encryptedFriendSecretKey = nacl.util.encodeBase64(friendSecretKey) /// generate a secret code 
//   //console.log('friendSecretKey', encryptedFriendSecretKey);
//   let friendKeypair = nacl.box.keyPair(encryptedFriendSecretKey);
//   //console.log('friendKeypair', friendKeypair)
//   friendKeypair.publicKey = nacl.util.encodeBase64(friendKeypair.publicKey);
//   friendKeypair.secretKey = nacl.util.encodeBase64(friendKeypair.secretKey);
//   //////////////////////////////////////////////////////////////////////////////////////////
//   //console.log('friendKeypairPublic:', friendKeypair.publicKey);
//   // console.log('friendKeypairSecret', friendKeypair.secretKey);
//   const { name, publicKeyString, content } = req.body;
//   //console.log('publicKeyString', publicKeyString);
//   const nonce = nacl.randomBytes(24);
//   //console.log('nonce', nonce);
//   const myKeyPair = nacl.box.keyPair.fromSecretKey(decodedSecretKey);
//   console.log('myKeyPairs', myKeyPair.publicKey);
//   // console.log(nacl.util.decodeUTF8(content));
//   // console.log(nacl.util.decodeBase64(publicKeyString));
//   // console.log('decodedSecret====>', decodedSecretKey);

//   const ciphertext = nacl.box(nacl.util.decodeUTF8(content), nonce,
//     nacl.util.decodeBase64(publicKeyString), decodedSecretKey);
//   console.log('ciphertext', ciphertext);
...
//       const messageString = nacl.util.encodeBase64(myKeyPair.publicKey) + response.data.id;
//       res.send(`
//       <html>
...
//   let messageString = req.query.messageString;
//   //messageString = messageString.split('=');
//   const id = messageString.slice(44, messageString.length);
//   const friendPK = messageString.slice(0, 44);

//   //e1vA6COT1H+7Mc+tAJgO41oeVSgC5naen5CFOPJlEyI=c1c20962de49a6f217a1906013e1d5e3
//   //console.log('id===>', id);
//   console.log('friendPK===>', friendPK);
//   github.gists.get({ id })
//     .then((response) => {
//       const file = Object.values(response.data.files);
//       //console.log('blob ===>', file[0].content);
//       const blob = file[0].content;

//       console.log('decodedSecretKey', decodedSecretKey);
...
//       // let bill = nacl.util.decodeBase64(blob.slice(32, blob.length))
//       console.log('friendPK2', nacl.util.decodeBase64(friendPK));

//       const plaintext = nacl.box.open(cipherText, nonce,
//         nacl.util.decodeBase64(friendPK),
//         decodedSecretKey
//       );
...
//   // console.log(friendPublicString);
//   // const id = messageString.slice(44, messageString.length);
//   // console.log(id);
