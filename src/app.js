...
const encryptor = process.env.SECRET_KEY ? nacl.util.decodeUTF8(process.env.SECRET_KEY) : nacl.randomBytes(32);
...
server.get('/keyPairGen', (req, res) => {
  ...
  const keypair = nacl.sign.keyPair(nacl.util.encodeBase64(encryptor));
