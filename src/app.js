...
server.get('/secretgist/:id', urlencodedParser, (req, res) => {
  ...
  .then(response => {
    ...
    const contentText = contentHash.slice(32, contentHash.length);

    const cipherText = nacel.util.decodeBase64(contentText);
