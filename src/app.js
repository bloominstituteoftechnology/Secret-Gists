...
const username = 'kiadorii'; // TODO: Replace with your username
...
let secretKey = process.env.SECRET_KEY ? nacl.util.decodeBase64(process.env.SECRET_KEY) : nacl.randomBytes(32);
