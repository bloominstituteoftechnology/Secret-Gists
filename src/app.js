...
const username = 'kait-schorr'; // TODO: Replace with your username
...
let secretKey = process.env.SECRET_KEY
  ? process.env.SECRET_KEY // nacl.util.decodeBase64(process.env.SECRET_KEY)
  : nacl.randomBytes(32);
...
server.get('/setkey:keyString', (req, res) => {
  ...
  try {
    ...
    res.send(`<div>Set the Key to : ${keyString}</div>`);
  } catch (err) {
    // failed
