...
const username = 'sagardesai90'; // TODO: Replace with your username
...
server.get('/setkey:keyString', (req, res) => {
  ...
  try {
    // TODO:
    const encodedString = nacl.util.decodeUTF8(keyString);
    const hashedString = nacl.hash(encodedString);
  ...
  github.gists.create({ files, public: true })
    .then((response) => {
      ...
      <html> 
        ...
        <body>
          <h1>Message Saved</h1>
          <div> Give this string to your friend for decryypting</div>
